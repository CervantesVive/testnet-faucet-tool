...
- **TUSDC in Stellar**: Rename to `TXLM:USDC` or verify actual BitGo asset ID
- **HTETH in Stellar**: Remove or replace with actual Stellar ETH asset ID (e.g., `TXLM:ETH`)
- **GHCN, GHDO, SOL:FORD**: Flag as "unconfirmed testnet assets — verify BitGo IDs before implementing"
