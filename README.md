...
History is stored as JSON lines at `~/.Custodian-faucet/history.log`.
...
A local SQLite rate limiter at `~/.Custodian-faucet/rate_limits.db` prevents accidental wallet drain:
